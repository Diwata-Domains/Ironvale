import{n as e}from"./chunk-DnJy8xQt.js";import{t}from"./iframe-Cz4-9Ekt.js";import{g as n,h as r,p as i,t as a}from"./src-BghEvbO8.js";function o({label:e,hint:t,children:n}){return(0,s.jsxs)(r,{gap:`sm`,children:[(0,s.jsx)(i,{as:`label`,variant:`label`,htmlFor:`input-story-field`,children:e}),n,t?(0,s.jsx)(i,{variant:`caption`,children:t}):null]})}var s,c,l,u,d,f;e((()=>{a(),s=t(),c={title:`Primitives/Input`,component:n,parameters:{layout:`padded`,docs:{description:{component:`Single-line form control primitive. Inputs require an external label in real usage, and validation or help text should be rendered adjacent to the field rather than encoded in the placeholder.`}}},args:{type:`text`,placeholder:`name@example.com`},argTypes:{type:{control:`select`,options:[`text`,`email`,`password`,`search`]}}},l={render:e=>(0,s.jsx)(`div`,{style:{width:`min(24rem, calc(100vw - 3rem))`},children:(0,s.jsx)(o,{label:`Email address`,hint:`Use a persistent label so the field stays understandable after the user types.`,children:(0,s.jsx)(n,{...e,id:`input-story-field`})})})},u={render:()=>(0,s.jsxs)(r,{gap:`md`,children:[(0,s.jsx)(o,{label:`Search`,children:(0,s.jsx)(n,{id:`search-field`,type:`search`,placeholder:`Search accounts`})}),(0,s.jsx)(o,{label:`Email`,children:(0,s.jsx)(n,{id:`email-field`,type:`email`,placeholder:`name@example.com`})}),(0,s.jsx)(o,{label:`Password`,children:(0,s.jsx)(n,{id:`password-field`,type:`password`,placeholder:`Enter password`})})]})},d={parameters:{docs:{description:{story:"The `error` prop only changes presentation. Pair it with adjacent error copy and appropriate validation semantics in the consuming form."}}},render:()=>(0,s.jsxs)(r,{gap:`md`,children:[(0,s.jsx)(o,{label:`Workspace name`,hint:`This name is already in use.`,children:(0,s.jsx)(n,{id:`workspace-field`,error:!0,defaultValue:`ironvale`,"aria-invalid":`true`})}),(0,s.jsx)(o,{label:`Archived field`,hint:`Disabled fields should still be explained when they cannot be edited.`,children:(0,s.jsx)(n,{id:`archived-field`,disabled:!0,defaultValue:`Locked value`})})]})},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
