...
Base reset and document styles are implemented in src/base.css, wired first into ironvale.css, and verified with pnpm build, pnpm validate, and pnpm typecheck.
