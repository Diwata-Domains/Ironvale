...
}`,h={title:`Guides/Adoption`,parameters:{layout:`fullscreen`,docs:{description:{component:`Adoption guide for installing Aether and Ironvale, enabling themes, and choosing between the CSS class API and optional React wrappers.`}}}},g={render:()=>(0,u.jsx)(`div`,{style:{padding:`2rem`,maxWidth:`72rem`,margin:`0 auto`},children:(0,u.jsxs)(n,{gap:`lg`,children:[(0,u.jsxs)(l,{title:`Install and import in order`,children:[(0,u.jsx)(r,{variant:`body`,children:`Ironvale does not ship its own token layer. Load Aether tokens first, then Ironvale CSS, so all component variables resolve against the semantic token contract.`}),(0,u.jsx)(c,{code:d}),(0,u.jsx)(r,{variant:`caption`,children:`In bundler-based apps, use the package import paths directly instead of reaching into workspace-relative files.`})]}),(0,u.jsxs)(l,{title:`Choose the API surface`,children:[(0,u.jsx)(r,{variant:`body`,children:`The CSS class API is the default cross-framework surface. React wrappers are optional and only translate props into those same class names.`}),(0,u.jsxs)(n,{direction:`horizontal`,gap:`lg`,wrap:!0,children:[(0,u.jsx)(a,{variant:`raised`,style:{flex:`1 1 22rem`},children:(0,u.jsxs)(n,{gap:`sm`,children:[(0,u.jsx)(r,{as:`h3`,variant:`heading`,children:`Plain HTML`}),(0,u.jsx)(c,{code:p})]})}),(0,u.jsx)(a,{variant:`raised`,style:{flex:`1 1 22rem`},children:(0,u.jsxs)(n,{gap:`sm`,children:[(0,u.jsx)(r,{as:`h3`,variant:`heading`,children:`React`}),(0,u.jsx)(c,{code:f}),(0,u.jsxs)(`div`,{children:[(0,u.jsx)(r,{as:`label`,variant:`label`,htmlFor:`adoption-story-input`,children:`Email address`}),(0,u.jsx)(`div`,{style:{marginTop:`0.5rem`},children:(0,u.jsx)(t,{id:`adoption-story-input`,type:`email`,placeholder:`name@example.com`})})]}),(0,u.jsx)(`div`,{children:(0,u.jsx)(i,{children:`Save contact`})})]})})]})]}),(0,u.jsxs)(l,{title:`Theme activation`,children:[(0,u.jsx)(r,{variant:`body`,children:`Ironvale follows Aether's theme model. Components flip automatically when the active theme changes because every primitive consumes semantic tokens only.`}),(0,u.jsx)(c,{code:`<body data-theme="dark">...</body>`}),(0,u.jsx)(r,{variant:`caption`,children:`Theme switching should happen at the application shell level. Ironvale components do not need per-component dark-mode props or overrides.`})]}),(0,u.jsxs)(l,{title:`Token overrides`,children:[(0,u.jsx)(r,{variant:`body`,children:`Override semantic tokens, not Ironvale classes. That keeps the library CSS stable while letting a product or brand layer redefine meaning at the token level.`}),(0,u.jsx)(c,{code:m}),(0,u.jsx)(r,{variant:`caption`,children:"Avoid overriding `iv-` classes directly unless you are intentionally forking the component contract for one application."})]}),(0,u.jsx)(l,{title:`Adoption checklist`,children:(0,u.jsxs)(n,{gap:`sm`,children:[(0,u.jsx)(r,{variant:`body`,children:"1. Install `@diwata/aether` and `@diwata/ironvale` together."}),(0,u.jsx)(r,{variant:`body`,children:"2. Import `@diwata/aether/tokens.css` before `@diwata/ironvale/ironvale.css`."}),(0,u.jsx)(r,{variant:`body`,children:`3. Use plain HTML classes everywhere; add React wrappers only where that improves ergonomics.`}),(0,u.jsx)(r,{variant:`body`,children:`4. Apply themes and brand changes through semantic token overrides.`})]})})]})})},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    padding: '2rem',
    maxWidth: '72rem',
    margin: '0 auto'
